    ...
    def process_frame(self, frame):
        ...
        for bbox1 in bbox1_idx:
            for i in edge_chipping:
                ...
                # Drawing a bounding box around the edge chipping
                cv2.rectangle(frame, (int(x3), int(y3)), (int(x4), int(y4)), (255, 0, 0), 2)

                # Display name of defect
            ...
            for bbox2 in bbox2_idx:
                for h in surface_defect:
                    ...
                    # Drawing a bounding box around the surface detect
            ...
            for bbox3 in bbox3_idx:
                for j in line_crack:
                    ...
                    # Drawing a bounding box around the line/crack
